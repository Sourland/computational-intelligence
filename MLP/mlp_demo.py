...
if __name__ == "__main__":
    ...
    total_training_times.append(end - start)
    plot_metrics(history, model_rmsprop_case1.name, batch_size=batch_size)
    ...
    total_training_times.append(end - start)
    plot_metrics(history, model_rmsprop_case2.name, batch_size=batch_size)
    ...
    total_training_times.append(end - start)
    plot_metrics(history, model_sgd_l1.name, batch_size=batch_size)
    ...
    total_training_times.append(end - start)
    plot_metrics(history, model_sgd_l2_case1.name, batch_size=batch_size)
    ...
    total_training_times.append(end - start)
    plot_metrics(history, model_sgd_l2_case2.name, batch_size=batch_size)
    ...
    total_training_times.append(end - start)
    plot_metrics(history, model_sgd_l2_case3.name, batch_size=batch_size)
