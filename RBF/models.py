...
rbf_layer_sizes = np.floor(np.array([0.1 * train_data_size, 0.5 * train_data_size, 0.9 * train_data_size])).astype(int)
...
history_1 = rbf_model_1.fit(x_train, y_train, epochs=100, batch_size=16, validation_split=0.2)
...
history_2 = rbf_model_2.fit(x_train, y_train, epochs=100, batch_size=16, validation_split=0.2)
...
history_3 = rbf_model_3.fit(x_train, y_train, epochs=100, batch_size=16, validation_split=0.2)
